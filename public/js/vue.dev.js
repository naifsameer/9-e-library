...
function generateCodeFrame(e, n = 0, r = e.length) {
  ...
  for (let t = 0; t < o.length; t++)
    if (((p += o[t].length + ((c[t] && c[t].length) || 0)), p >= n)) {
      for (let e = t - range; e <= t + range || r > p; e++)
        e < 0 ||
          e >= o.length ||
          ((a = e + 1),
          u.push(
            `${a}${' '.repeat(Math.max(3 - String(a).length, 0))}|  ${o[e]}`
          ),
          (s = o[e].length),
          (i = (c[e] && c[e].length) || 0),
          e === t
            ? ((a = n - (p - (s + i))),
              (l = Math.max(1, r > p ? s - a : r - n)),
              u.push('   |  ' + ' '.repeat(a) + '^'.repeat(l)))
            : e > t &&
              (r > p &&
...
function track(n, r, o) {
  if (shouldTrack && activeEffect) {
    ...
    e || targetMap.set(n, (e = new Map()));
    let t = e.get(o);
    t || e.set(o, (t = createDep()));
    o = { effect: activeEffect, target: n, type: r, key: o };
    trackEffects(t, o);
  }
}
...
function trigger(e, t, r, o, s, i) {
  ...
  if (a) {
    ...
    i = { target: e, type: t, key: r, newValue: o, oldValue: s, oldTarget: i };
    if (1 === n.length) n[0] && triggerEffects(n[0], i);
    else {
      const l = [];
      for (const c of n) c && l.push(...c);
      triggerEffects(createDep(l), i);
    }
  }
}
function triggerEffects(e, t) {
  for (const n of isArray(e) ? e : [...e])
    (n === activeEffect && !n.allowRecurse) ||
      (n.onTrigger && n.onTrigger(extend({ effect: n }, t)),
...
function createSetter(a = !1) {
  return function (e, t, n, r) {
    ...
    if (
      !a &&
      !isReadonly(n) &&
      (isShallow(n) || ((n = toRaw(n)), (o = toRaw(o))),
...
function get$1(e, t, n = !1, r = !1) {
  var o = toRaw((e = e.__v_raw)),
    s = toRaw(t);
  t !== s && (n || track(o, 'get', t)), n || track(o, 'get', s);
...
function checkIdentityKeys(e, t, n) {
  ...
  r !== n &&
    ...
    ((e = toRawType(e)),
    console.warn(
      `Reactive ${e} contains both the raw and reactive ` +
        `versions of the same object${'Map' === e ? ' as keys' : ''}, ` +
...
function formatTraceEntry({ vnode: e, recurseCount: t }) {
  var n = 0 < t ? `... (${t} recursive calls)` : '',
    t = !!e.component && null == e.component.parent,
    t = ` at <${formatComponentName(e.component, e.type, t)}`,
    n = '>' + n;
  return e.props ? [t, ...formatProps(e.props), n] : [t + n];
}
...
function flushPreFlushCbs(e, t = null) {
  if (pendingPreFlushCbs.length) {
    for (
      ...
      checkRecursiveUpdates(e, activePreFlushCbs[preFlushIndex]) ||
...
function flushJobs(e) {
  ...
  try {
    for (flushIndex = 0; flushIndex < queue.length; flushIndex++) {
      ...
      t &&
        !1 !== t.active &&
        (checkRecursiveUpdates(e, t) || callWithErrorHandling(t, null, 14));
    }
  } finally {
    (flushIndex = 0),
      (queue.length = 0),
      ...
      hmrDirtyComponents.has(r) ||
        ...
        s.ceReload
          ...
          ? (queueJob(s.parent.update),
            s.parent.type.__asyncLoader &&
              s.parent.ceReload &&
              s.parent.ceReload(t.styles))
          : s.appContext.reload
          ? s.appContext.reload()
          : 'undefined' != typeof window
...
function emit$1(e, t, ...n) {
  ...
  if (o)
    if (t in o) {
      ...
      (s && toHandlerKey(t) in s) ||
        warn$1(
          `Component emitted event "${t}" but it is neither declared in ` +
            `the emits option nor as an "${toHandlerKey(t)}" prop.`
        );
  let i = n;
  var a = t.startsWith('update:'),
    o = a && t.slice(7);
  o &&
    o in r &&
    (({ number: s, trim: o } =
      r[`${'modelValue' === o ? 'model' : o}Modifiers`] || EMPTY_OBJ),
    o ? (i = n.map((e) => e.trim())) : s && (i = n.map(toNumber))),
    devtoolsComponentEmit(e, t, i);
  n = t.toLowerCase();
  n !== t &&
    r[toHandlerKey(n)] &&
    warn$1(
      `Event "${n}" is emitted in component ` +
        `${formatComponentName(
          e,
          e.type
        )} but the handler is registered for "${t}". ` +
        ...
        `You should probably use "${hyphenate(t)}" instead of "${t}".`
    );
  let l,
    c = r[(l = toHandlerKey(t))] || r[(l = toHandlerKey(camelize(t)))];
  !c && a && (c = r[(l = toHandlerKey(hyphenate(t)))]),
  ...
  if (r) {
    ...
    (e.emitted[l] = !0), callWithAsyncErrorHandling(r, e, 6, i);
  }
}
...
function withCtx(n, r = currentRenderingInstance, e) {
  if (!r) return n;
  if (n._n) return n;
  const o = (...e) => {
    o._d && setBlockTracking(-1);
    var t = setCurrentRenderingInstance(r),
      e = n(...e);
    return (
      setCurrentRenderingInstance(t),
      o._d && setBlockTracking(1),
      devtoolsComponentUpdated(r),
      e
    );
  };
...
function renderComponentRoot(t) {
  ...
  try {
    if (4 & n.shapeFlag) {
      var E = o || r;
      (g = normalizeVNode(p.call(E, E, u, s, f, d, h))), (v = l);
    } else {
      const p = e;
  ...
  let C = g,
    S = void 0;
  if (
    (0 < g.patchFlag && 2048 & g.patchFlag && ([C, S] = getChildRoot(g)),
    v && !1 !== m)
  ) {
...
function shouldUpdateComponent(e, t, n) {
  var { props: r, children: o, component: s } = e,
    { props: i, children: a, patchFlag: e } = t,
    l = s.emitsOptions;
  if ((o || a) && isHmrUpdating) return !0;
  if (t.dirs || t.transition) return !0;
  if (!(n && 0 <= e))
    return (
      !((!o && !a) || (a && a.$stable)) ||
      (r !== i && (r ? !i || hasPropsChanged(r, i, l) : !!i))
    );
  if (1024 & e) return !0;
  if (16 & e) return r ? hasPropsChanged(r, i, l) : !!i;
  if (8 & e) {
...
function patchSuspense(
  ...
  if (m)
    isSameVNodeType((u.pendingBranch = d), m)
      ? (l(m, d, u.hiddenContainer, null, o, u, s, i, a),
        u.deps <= 0
          ? u.resolve()
          : g && (l(h, f, n, r, o, null, s, i, a), setActiveBranch(u, f)))
      : (u.pendingId++,
        e ? ((u.isHydrating = !1), (u.activeBranch = m)) : c(m, o, u),
        (u.deps = 0),
        (u.effects.length = 0),
        (u.hiddenContainer = p('div')),
        g
          ? (l(null, d, u.hiddenContainer, null, o, u, s, i, a),
            u.deps <= 0
              ? u.resolve()
              : (l(h, f, n, r, o, null, s, i, a), setActiveBranch(u, f)))
          : h && isSameVNodeType(d, h)
          ? (l(h, d, n, r, o, u, s, i, a), u.resolve(!0))
          : (l(null, d, u.hiddenContainer, null, o, u, s, i, a),
            u.deps <= 0 && u.resolve()));
  else if (h && isSameVNodeType(d, h))
    l(h, d, n, r, o, u, s, i, a), setActiveBranch(u, d);
  else if (
      ...
      n.asyncDep
        ...
        .then((e) => {
          if (
            ...
            e = !s && n.subTree.el;
            r(n, t, m(s || n.subTree.el), s ? null : h(n.subTree), v, i, p),
              e && g(e),
...
function hydrateSuspense(e, t, n, r, o, s, i, a, l) {
  ...
  i = l(e, (c.pendingBranch = t.ssContent), n, c, s, i);
  return 0 === c.deps && c.resolve(), i;
}
...
function watchPostEffect(e, t) {
  return doWatch(e, null, Object.assign(t || {}, { flush: 'post' }));
}
function watchSyncEffect(e, t) {
  return doWatch(e, null, Object.assign(t || {}, { flush: 'sync' }));
}
...
function doWatch(
  ...
  const m = () => {
    if (v.active)
      if (t) {
        ...
        (r ||
          p ||
          (u ? e.some((e, t) => hasChanged(e, h[t])) : hasChanged(e, h))) &&
          (d && d(),
  ...
  g =
    'sync' === o
      ...
      : () => {
          !l || l.isMounted ? queuePreFlushCb(m) : m();
        };
...
function instanceWatch(e, t, n) {
  ...
  n = doWatch(o, s.bind(r), n);
  return t ? setCurrentInstance(t) : unsetCurrentInstance(), n;
}
  ...
  BaseTransitionImpl = {
    ...
    setup(p, { slots: e }) {
      const u = getCurrentInstance(),
        d = useTransitionState();
      let f;
      return () => {
        var t = e.default && getTransitionRawChildren(e.default(), !0);
        if (t && t.length) {
          1 < t.length &&
            warn$1(
          ...
          var o = t[0];
          if (d.isLeaving) return emptyPlaceholder(o);
          var s = getKeepAliveChild(o);
          if (!s) return emptyPlaceholder(o);
          const i = resolveTransitionHooks(s, n, d, u);
          setTransitionHooks(s, i);
          t = u.subTree;
          const a = t && getKeepAliveChild(t);
          let e = !1;
          const l = s.type['getTransitionKey'];
          if (
            (l &&
              ((t = l()),
              void 0 === f ? (f = t) : t !== f && ((f = t), (e = !0))),
            a && a.type !== Comment && (!isSameVNodeType(s, a) || e))
          ) {
            const c = resolveTransitionHooks(a, n, d, u);
            if ((setTransitionHooks(a, c), 'out-in' === r))
              return (
                (d.isLeaving = !0),
                (c.afterLeave = () => {
                  (d.isLeaving = !1), u.update();
                }),
                emptyPlaceholder(o)
              );
            'in-out' === r &&
              s.type !== Comment &&
              (c.delayLeave = (e, t, n) => {
                const r = getLeavingNodesForType(d, a);
                (r[String(a.key)] = a),
                  (e._leaveCb = () => {
...
function getTransitionRawChildren(t, n = !1) {
  let r = [],
    o = 0;
  for (let e = 0; e < t.length; e++) {
    var s = t[e];
    s.type === Fragment
      ? (128 & s.patchFlag && o++,
        (r = r.concat(getTransitionRawChildren(s.children, n))))
      : (!n && s.type === Comment) || r.push(s);
  }
  if (1 < o) for (let e = 0; e < r.length; e++) r[e].patchFlag = -2;
  return r;
}
  ...
  KeepAliveImpl = {
    ...
    setup(a, { slots: l }) {
      const r = getCurrentInstance(),
        e = r.ctx;
      if (!e.renderer) return l.default;
      const c = new Map(),
        p = new Set();
      let u = null;
      r.__v_cache = c;
        ...
        onBeforeUnmount(() => {
          c.forEach((e) => {
            ...
            e.type !== t.type
              ? s(e)
              : (resetShapeFlag(t),
                (t = t.component.da) && queuePostRenderEffect(t, n));
          });
        }),
        () => {
          ...
          var r = n.type,
            o = getComponentName(
              isAsyncWrapper(n) ? n.type.__asyncResolved || {} : r
            ),
            { include: s, exclude: i, max: e } = a;
          if ((s && (!o || !matches(s, o))) || (i && o && matches(i, o)))
            return (u = n), t;
          ...
          return (
            ...
            r
              ? ((n.el = r.el),
                ...
                p.add(o))
              : (p.add(o),
                e && p.size > parseInt(e, 10) && m(p.values().next().value)),
            (n.shapeFlag |= 256),
            (u = n),
            t
          );
...
function injectHook(t, n, r = currentInstance, e = !1) {
  ...
  warn$1(
    `${toHandlerKey(
      ErrorTypeStrings[t].replace(/ hook$/, '')
    )} is called when there is no active component instance to be ` +
      'associated with. Lifecycle injection APIs can only be used during execution of setup(). If you are using async setup(), make sure to register lifecycle hooks before the first await statement.'
  );
}
const createHook =
    (n) =>
    (e, t = currentInstance) =>
      (!isInSSRComponentSetup || 'sp' === n) && injectHook(n, e, t),
...
function applyOptions(e) {
  ...
  const {
    ...
    O = createDuplicateChecker();
  var [t] = e.propsOptions;
  if (t) for (const I in t) O('Props', I);
  if (
    (c && resolveInjections(c, r, O, e.appContext.config.unwrapInjectedRef), i)
  )
    for (const A in i) {
      const M = i[A];
      isFunction(M)
        ? (Object.defineProperty(r, A, {
          ...
          O('Methods', A))
        : warn$1(
            `Method "${A}" has type "${typeof M}" in the component definition. ` +
  ...
  if (((shouldCacheAccess = !0), s))
    for (const F in s) {
      ...
      var N = isFunction(D)
        ...
        ? D.get.bind(n, n)
        : NOOP;
      N === NOOP && warn$1(`Computed property "${F}" has no getter.`);
      var k =
        !isFunction(D) && isFunction(D.set)
          ? D.set.bind(n)
          : () => {
              warn$1(
      ...
      const B = computed$1({ get: N, set: k });
  ...
  if (a) for (const H in a) createWatcher(a[H], r, n, H);
  if (l) {
    const L = isFunction(l) ? l.call(n) : l;
  ...
  if (
    ...
    P(onErrorCaptured, b),
    P(onRenderTracked, C),
    P(onRenderTriggered, S),
    P(onBeforeUnmount, v),
    P(onUnmounted, y),
    P(onServerPrefetch, T),
    isArray(_))
  )
    if (_.length) {
...
function updateProps(t, n, r, e) {
  ...
  if (
    t.type.__hmrId ||
    (t.parent && t.parent.type.__hmrId) ||
    !(e || 0 < i) ||
    16 & i
  ) {
    ...
    for (let e = 0; e < p.length; e++) {
      ...
      !l || hasOwn(s, u)
        ? d !== s[u] && ((s[u] = d), (c = !0))
        : ((u = camelize(u)), (o[u] = resolvePropValue(l, a, u, d, t, !1)));
    }
  }
...
function resolvePropValue(e, t, n, r, o, s) {
  ...
  if (null != i) {
    ...
    if (e && void 0 === r) {
      const a = i.default;
      if (i.type !== Function && isFunction(a)) {
...
function normalizePropsOptions(e, n, t = !1) {
  ...
  if (
    (isFunction(e) ||
      ((f = (e) => {
        l = !0;
        var [t, e] = normalizePropsOptions(e, n, !0);
        extend(i, t), e && a.push(...e);
      }),
    ...
    return r.set(e, EMPTY_ARR), EMPTY_ARR;
  if (isArray(s))
    ...
    for (const h in s) {
      ...
      if (validatePropName(p)) {
        var u,
          d = s[h];
        const m = (i[p] = isArray(d) || isFunction(d) ? { type: d } : d);
        m &&
          ((u = getTypeIndex(Boolean, m.type)),
          (d = getTypeIndex(String, m.type)),
          (m[0] = -1 < u),
          (m[1] = d < 0 || u < d),
          (-1 < u || hasOwn(m, 'default')) && a.push(p));
      }
    }
  }
  var f = [i, a];
...
function getInvalidTypeMessage(e, t, n) {
  let r =
    ...
    ` Expected ${n.map(capitalize).join(' | ')}`;
  var o = n[0],
    s = toRawType(t),
    e = styleValue(t, o),
    t = styleValue(t, s);
...
function withDirectives(e, s) {
  ...
  for (let o = 0; o < s.length; o++) {
    ...
    isFunction(e) && (e = { mounted: e, updated: e }),
      e.deep && traverse(t),
      a.push({
        dir: e,
        instance: i,
...
function createHydrationFunctions(m) {
  const {
    mt: g,
    p: u,
    o: {
  ...
  const C = (t, n, e, r, o, s = !1) => {
      const i = isComment(t) && '[' === t.data;
      var a = () => _(t, n, e, r, o, i),
        { type: l, ref: c, shapeFlag: p } = n,
        u = t.nodeType;
      n.el = t;
      let d = null;
      switch (l) {
              ...
              : (t.data !== n.children &&
                  ...
                  warn$1(
                    'Hydration text mismatch:' +
                      ...
                      `\n- Server: ${JSON.stringify(n.children)}`
                  ),
                  (t.data = n.children)),
                v(t));
          break;
        ...
        case Static:
          if (1 === u) {
            ...
            for (let e = 0; e < n.staticCount; e++)
              f && (n.children += d.outerHTML),
                e === n.staticCount - 1 && (n.anchor = d),
                (d = v(d));
            return d;
          }
          d = a();
        ...
        default:
          if (1 & p)
            d =
              1 !== u || n.type.toLowerCase() !== t.tagName.toLowerCase()
                ? a()
                : S(t, n, e, r, o, s);
          else if (6 & p) {
            n.slotScopeIds = o;
            var h = y(t);
            if (
              (g(n, h, null, e, r, isSVGContainer(h), s),
              (d = (i ? w : v)(t)),
              isAsyncWrapper(n))
            ) {
              let e;
              i
                ? ((e = createVNode(Fragment)),
                  (e.anchor = d ? d.previousSibling : h.lastChild))
                : (e =
                    3 === t.nodeType
                      ? createTextVNode('')
                      : createVNode('div')),
            ...
            64 & p
              ? (d = 8 !== u ? a() : n.type.hydrate(t, n, e, r, o, s, m, b))
              : 128 & p
              ? (d = n.type.hydrate(
                  t,
                  n,
      ...
      return null != c && setRef(c, null, r, n), d;
    },
    S = (n, r, o, s, i, a) => {
      ...
      var u = ('input' === e && p) || 'option' === e;
      {
        ...
        if (
          ...
          let e = b(n.firstChild, r, n, o, s, i, a),
            t = !1;
          for (; e; ) {
            (hasMismatch = !0),
              t ||
    ...
    T = (e, t, n, r, o, s) => {
      ...
      i && (o = o ? o.concat(i) : i);
      (i = y(e)), (s = b(v(e), t, i, n, r, o, s));
      return s && isComment(s) && ']' === s.data
        ? v((t.anchor = s))
        : ((hasMismatch = !0), a((t.anchor = l(']')), i, s), s);
    },
    _ = (e, t, n, r, o, s) => {
      if (
        ((hasMismatch = !0),
      ...
      const a = v(e);
      s = y(e);
      return E(e), u(null, t, s, a, n, r, isSVGContainer(s), o), a;
    },
    w = (e) => {
      let t = 0;
      for (; e; )
...
function startMeasure(e, t) {
  e.appContext.config.performance &&
    ...
    devtoolsPerfStart(e, t, (supported ? perf : Date).now());
}
function endMeasure(e, t) {
  ...
  e.appContext.config.performance &&
    ...
    perf.clearMarks(n),
    perf.clearMarks(r)),
    devtoolsPerfEnd(e, t, (supported ? perf : Date).now());
}
...
function baseCreateRenderer(e, t) {
  ...
  (n.__VUE__ = !0), setDevtoolsHook(n.__VUE_DEVTOOLS_GLOBAL_HOOK__, n);
  const {
      insert: v,
      remove: c,
      patchProp: E,
    ...
    O = (
      ...
      i = !1,
      a = null,
      l = !isHmrUpdating && !!t.dynamicChildren
    ) => {
      if (e !== t) {
        e && !isSameVNodeType(e, t) && ((r = L(e)), B(e, o, s, !0), (e = null)),
          -2 === t.patchFlag && ((l = !1), (t.dynamicChildren = null));
        const { type: f, ref: h, shapeFlag: m } = t;
        switch (f) {
          case Text:
            ((e, t, n, r) => {
              if (e == null) v((t.el = g(t.children)), n, r);
              else {
                const o = (t.el = e.el);
                if (t.children !== e.children) C(o, t.children);
              }
            })(e, t, n, r);
            break;
          case Comment:
          ...
          case Static:
            null == e
              ? ((c = t),
                ...
                (u = r),
                (d = i),
                ([c.el, c.anchor] = _(c.children, p, u, d, c.el, c.anchor)))
              : ((e, t, n, r) => {
                  if (t.children !== e.children) {
                    const o = T(e.anchor);
                    x(e);
                    [t.el, t.anchor] = _(t.children, n, o, r);
                  } else {
                    t.el = e.el;
                    t.anchor = e.anchor;
                  }
          ...
          case Fragment:
            ((e, t, n, r, o, s, i, a, l) => {
              const c = (t.el = e ? e.el : g('')),
                p = (t.anchor = e ? e.anchor : g(''));
              let { patchFlag: u, dynamicChildren: d, slotScopeIds: f } = t;
              if (isHmrUpdating) {
                u = 0;
                l = false;
                d = null;
              }
              if (f) a = a ? a.concat(f) : f;
              if (e == null) {
                v(c, n, r);
                v(p, n, r);
                k(t.children, n, p, o, s, i, a, l);
              } else if (u > 0 && u & 64 && d && e.dynamicChildren) {
                I(e.dynamicChildren, d, n, o, s, i, a);
                if (o && o.type.__hmrId) traverseStaticChildren(e, t);
                else if (t.key != null || (o && t === o.subTree))
                  traverseStaticChildren(e, t, true);
              } else F(e, t, n, p, o, s, i, a, l);
            })(e, t, n, r, o, s, i, a, l);
            break;
          default:
            1 & m
              ? ((e, t, n, r, o, s, i, a, l) => {
                  if (((i = i || t.type === 'svg'), e == null))
                    R(t, n, r, o, s, i, a, l);
                  else P(e, t, o, s, i, a, l);
                })(e, t, n, r, o, s, i, a, l)
              : 6 & m
              ? ((e, t, n, r, o, s, i, a, l) => {
                  if (((t.slotScopeIds = a), e == null))
                    if (t.shapeFlag & 512) o.ctx.activate(t, n, r, i, l);
                    else M(t, n, r, o, s, i, l);
                  else V(e, t, l);
                })(e, t, n, r, o, s, i, a, l)
              : 64 & m || 128 & m
              ? f.process(e, t, n, r, o, s, i, a, l, j)
              : warn$1('Invalid VNode type:', f, `(${typeof f})`);
        }
        var c, p, u, d;
        null != h && o && setRef(h, e && e.ref, s, t || e, !t);
      }
    },
    w = (e, t, n, r) => {
    ...
    x = ({ el: e, anchor: t }) => {
      for (var n; e && e !== t; ) (n = T(e)), c(e), (e = n);
      c(t);
    },
    R = (e, t, n, r, o, s, i, a) => {
      let l, c;
      const { type: p, props: u, shapeFlag: d, transition: f, dirs: h } = e;
      if (
        ((l = e.el = y(e.type, s, u && u.is, u)),
        8 & d
          ? S(l, e.children)
          : 16 & d &&
            k(e.children, l, null, r, o, s && 'foreignObject' !== p, i, a),
        ...
        for (const g in u)
          'value' === g ||
            isReservedProp(g) ||
            E(l, g, null, u[g], s, e.children, r, o, H);
    ...
    N = (t, n, e, r, o) => {
      if ((e && s(t, e), r)) for (let e = 0; e < r.length; e++) s(t, r[e]);
      if (o) {
        let e = o.subTree;
        0 < e.patchFlag &&
          2048 & e.patchFlag &&
          (e = filterSingleRoot(e.children) || e),
          n === e &&
            ((n = o.vnode), N(t, n, n.scopeId, n.slotScopeIds, o.parent));
      }
    },
    k = (t, n, r, o, s, i, a, l, c = 0) => {
    ...
    P = (t, e, n, r, o, s, i) => {
      ...
      if (
        (c
          ? (I(t.dynamicChildren, c, a, n, r, h, s),
            n && n.type.__hmrId && traverseStaticChildren(t, e))
          : i || F(t, e, a, null, n, r, h, s, !1),
        0 < l)
      ) {
        if (16 & l) A(a, e, u, d, n, r, o);
        else if (
          ...
          for (let e = 0; e < m.length; e++) {
            var g = m[e],
              v = u[g],
              y = d[g];
            (y === v && 'value' !== g) || E(a, g, v, y, o, t.children, n, r, H);
          }
        }
        1 & l && t.children !== e.children && S(a, e.children);
      } else i || null != c || A(a, e, u, d, n, r, o);
      ...
      if (n !== r) {
        for (const c in r) {
          ...
          isReservedProp(c) ||
            ((a = r[c]) !== (l = n[c]) &&
              'value' !== c &&
              E(e, c, l, a, i, t.children, o, s, H));
        }
        if (n !== EMPTY_OBJ)
          for (const p in n)
            isReservedProp(p) ||
              p in r ||
              E(e, p, n[p], null, i, t.children, o, s, H);
    ...
    M = (e, t, n, r, o, s, i) => {
      ...
      if (
        ...
        isKeepAlive(e) && (a.ctx.renderer = j),
        startMeasure(a, 'init'),
        setupComponent(a),
        endMeasure(a, 'init'),
        a.asyncDep)
        ...
        return (
          o && o.registerDep(a, l),
          void (
            e.el || ((r = a.subTree = createVNode(Comment)), w(null, r, t, n))
          )
        );
    ...
    V = (e, t, n) => {
      ...
      shouldUpdateComponent(e, t, n)
        ? r.asyncDep && !r.asyncResolved
          ? (pushWarningContext(t), $(r, t, n), popWarningContext())
          ...
          () => {
            if (u.isMounted) {
              ...
              if (
                ...
                startMeasure(u, 'render');
                a = u.subTree = renderComponentRoot(u);
                endMeasure(u, 'render'),
                  startMeasure(u, 'patch'),
                  O(null, a, f, h, u, m, g),
                  endMeasure(u, 'patch'),
              ...
              if (
                ...
                !i && (e = n && n.onVnodeMounted))
              ) {
                const p = d;
                queuePostRenderEffect(() => invokeVNodeHook(e, s, p), m);
              }
              256 & d.shapeFlag && u.a && queuePostRenderEffect(u.a, m),
                (u.isMounted = !0),
    ...
    F = (e, t, n, r, o, s, i, a, l = !1) => {
      var c = e && e.children,
        p = e ? e.shapeFlag : 0,
        u = t.children,
        { patchFlag: e, shapeFlag: t } = t;
      if (0 < e) {
        if (128 & e) return void d(c, u, n, r, o, s, i, a, l);
        if (256 & e)
          return void ((e, t, n, r, o, s, i, a, l) => {
            (e = e || EMPTY_ARR), (t = t || EMPTY_ARR);
            const c = e.length,
              p = t.length,
              u = Math.min(c, p);
            let d;
            for (d = 0; d < u; d++) {
              const f = (t[d] = l
                ? cloneIfMounted(t[d])
                : normalizeVNode(t[d]));
              O(e[d], f, n, null, o, s, i, a, l);
            }
            if (c > p) H(e, o, s, true, false, u);
            else k(t, n, r, o, s, i, a, l, u);
          })(c, u, n, r, o, s, i, a, l);
      }
      8 & t
        ? (16 & p && H(c, o, s), u !== c && S(n, u))
        : 16 & p
        ? 16 & t
          ? d(c, u, n, r, o, s, i, a, l)
          : H(c, o, s, !0)
        : (8 & p && S(n, ''), 16 & t && k(u, n, r, o, s, i, a, l));
    },
    d = (e, s, i, a, l, c, p, u, d) => {
      let f = 0;
      var h = s.length;
      ...
      for (; f <= m && f <= g; ) {
        ...
        O(r, o, i, null, l, c, p, u, d), m--, g--;
      }
      if (f > m) {
        if (f <= g)
          for (var v = g + 1, y = v < h ? s[v].el : a; f <= g; )
            O(
              null,
              ...
              f++;
      } else if (f > g) for (; f <= m; ) B(e[f], l, c, !0), f++;
      else {
        var v = f,
          E = f;
        const x = new Map();
        for (f = E; f <= g; f++) {
          var C = (s[f] = (d ? cloneIfMounted : normalizeVNode)(s[f]));
          null != C.key &&
            (x.has(C.key) &&
              warn$1(
        ...
        for (t = T.length - 1, f = S - 1; 0 <= f; f--) {
          var _ = E + f,
            w = s[_],
            _ = _ + 1 < h ? s[_ + 1].el : a;
          0 === R[f]
            ? O(null, w, i, _, l, c, p, u, d)
            : r && (t < 0 || f !== T[t] ? D(w, i, _, 2) : t--);
        }
      }
    },
    D = (e, t, n, r, o = null) => {
      const { el: s, type: i, transition: a, children: l, shapeFlag: c } = e;
      if (6 & c) D(e.component.subTree, t, n, r);
      else if (128 & c) e.suspense.move(t, n, r);
      else if (64 & c) i.move(e, t, n, j);
      else if (i !== Fragment)
        if (i !== Static)
          if (2 !== r && 1 & c && a)
            if (0 === r)
              ...
              const { leave: p, delayLeave: u, afterLeave: d } = a,
                f = () => v(s, t, n);
              o = () => {
                p(s, () => {
                  f(), d && d();
          ...
          (({ el: e, anchor: t }, n, r) => {
            for (var o; e && e !== t; ) (o = T(e)), v(e, n, r), (e = o);
            v(t, n, r);
          })(e, t, n);
      else {
        v(s, t, n);
        for (let e = 0; e < l.length; e++) D(l[e], t, n, r);
        v(e.anchor, t, n);
      }
    },
    B = (t, n, r, o = !1, s = !1) => {
      ...
      if ((null != e && setRef(e, null, r, t, !0), 256 & p))
        n.ctx.deactivate(t);
      else {
        const f = 1 & p && d;
        d = !isAsyncWrapper(t);
        let e;
        if (
          (d && (e = a && a.onVnodeBeforeUnmount) && invokeVNodeHook(e, n, t),
          6 & p)
        )
          m(t.component, r, o);
        else {
          if (128 & p) return void t.suspense.unmount(r, o);
          f && invokeDirectiveHook(t, null, n, 'beforeUnmount'),
            64 & p
              ? t.type.remove(t, n, r, s, j, o)
              : c && (i !== Fragment || (0 < u && 64 & u))
              ? H(c, n, r, !1, !0)
              : ((i === Fragment && 384 & u) || (!s && 16 & p)) && H(l, n, r),
            o && h(t);
        }
        ((d && (e = a && a.onVnodeUnmounted)) || f) &&
          queuePostRenderEffect(() => {
            e && invokeVNodeHook(e, n, t),
              f && invokeDirectiveHook(t, null, n, 'unmounted');
          }, r);
      }
    },
    h = (e) => {
    ...
    H = (t, n, r, o = !1, s = !1, i = 0) => {
      for (let e = i; e < t.length; e++) B(t[e], n, r, o, s);
    },
    L = (e) =>
      6 & e.shapeFlag
  ...
  return (
    t && ([i, U] = t(j)),
    { render: r, hydrate: i, createApp: createAppAPI(r, i) }
  );
}
    ...
    for (let t = 0; t < r.length; t++) {
      ...
      1 & e.shapeFlag &&
        ...
        ((e.patchFlag <= 0 || 32 === e.patchFlag) &&
          ((e = o[t] = cloneIfMounted(o[t])), (e.el = s.el)),
...
const isTeleport = (e) => e.__isTeleport,
  ...
  resolveTarget = (e, t) => {
    ...
    return (
      n || isTeleportDisabled(e) || warn$1(`Invalid Teleport target: ${n}`), n
    );
  },
  TeleportImpl = {
    __isTeleport: !0,
    process(e, t, n, r, o, s, i, a, l, c) {
      ...
      isHmrUpdating && ((l = !1), (w = null)),
        null == e
          ? ((v = t.el = g('teleport start')),
            (y = t.anchor = g('teleport end')),
            f(v, n, r),
            f(y, n, r),
            (C = t.target = resolveTarget(t.props, h)),
            (S = t.targetAnchor = m('')),
            C
              ? (f(S, C), (i = i || isTargetSVG(C)))
              : b ||
                warn$1('Invalid Teleport target on mount:', C, `(${typeof C})`),
            (E = (e, t) => {
          ...
          : ((t.el = e.el),
            ...
            (C = (E = isTeleportDisabled(e.props)) ? n : r),
            (S = E ? v : y),
            (i = i || isTargetSVG(r)),
            w
            ...
            b
              ? E || moveTeleport(t, n, v, c, 1)
              : (t.props && t.props.to) !== (e.props && e.props.to)
              ? (e = t.target = resolveTarget(t.props, h))
                ? moveTeleport(t, e, null, c, 0)
                : warn$1(
                    'Invalid Teleport target on update:',
                    r,
                    `(${typeof r})`
                  )
              : E && moveTeleport(t, r, y, c, 1));
    },
    remove(e, t, n, r, { um: o, o: { remove: s } }, i) {
      ...
      if ((u && s(p), (i || !isTeleportDisabled(e)) && (s(c), 16 & a)))
...
function moveTeleport(e, t, n, { o: { insert: r }, m: o }, s = 2) {
  ...
  var { el: i, anchor: a, shapeFlag: l, children: c, props: e } = e,
    s = 2 === s;
  if ((s && r(i, t, n), (!s || isTeleportDisabled(e)) && 16 & l))
    ...
    p &&
      ...
      16 & t.shapeFlag &&
        (isTeleportDisabled(t.props)
          ? ((t.anchor = c(i(e), t, a(e), n, r, o, s)), (t.targetAnchor = l))
          : ((t.anchor = i(e)), (t.targetAnchor = c(l, t, p, n, r, o, s))),
...
function resolveAsset(e, t, n = !0, r = !1) {
  ...
  if (o) {
    var s = o.type;
    if (e === COMPONENTS) {
      var i = getComponentName(s);
      if (i && (i === t || i === camelize(t) || i === capitalize(camelize(t))))
        return s;
    }
    o = resolve(o[e] || s[e], t) || resolve(o.appContext[e], t);
    return !o && r
      ? s
      : (n &&
          !o &&
          ((n =
            e === COMPONENTS
              ...
              : ''),
          warn$1(`Failed to resolve ${e.slice(0, -1)}: ${t}${n}`)),
        o);
  }
  warn$1(
...
function isSameVNodeType(e, t) {
  return (
    !(6 & t.shapeFlag && hmrDirtyComponents.has(t.type)) &&
    e.type === t.type &&
    e.key === t.key
  );
}
...
function _createVNode(e, n = null, t = null, r = 0, o = null, s = !1) {
  if (
    ...
    var i = cloneVNode(e, n, !0);
    return t && normalizeChildren(i, t), i;
  }
...
function toHandlers(e) {
  const t = {};
  if (!isObject(e))
    return warn$1('v-on with no argument expects an object value.'), t;
  for (const n in e) t[toHandlerKey(n)] = e[n];
  return t;
}
const getPublicInstance = (e) =>
  ...
  PublicInstanceProxyHandlers = {
    get({ _: e }, t) {
      ...
      if (r !== EMPTY_OBJ && r.__isScriptSetup && hasOwn(r, t)) return r[t];
      if ('$' !== t[0]) {
        var c = i[t];
        if (void 0 !== c)
          switch (c) {
          ...
          if (r !== EMPTY_OBJ && hasOwn(r, t)) return (i[t] = 1), r[t];
    ...
    set({ _: e }, t, n) {
      ...
      return o !== EMPTY_OBJ && hasOwn(o, t)
        ...
        ? ((r[t] = n), !0)
        : hasOwn(e.props, t)
        ? (warn$1(`Attempting to mutate prop "${t}". Props are readonly.`, e),
          !1)
        : '$' === t[0] && t.slice(1) in e
        ? (warn$1(
...
function setupComponent(e, t = !1) {
  ...
  initProps(e, n, o, t), initSlots(e, r);
  t = o ? setupStatefulComponent(e, t) : void 0;
  return (isInSSRComponentSetup = !1), t;
}
function setupStatefulComponent(t, n) {
  ...
  var s = e['setup'];
  if (s) {
    e = t.setupContext = 1 < s.length ? createSetupContext(t) : null;
    setCurrentInstance(t), pauseTracking();
    const i = callWithErrorHandling(s, t, 0, [shallowReadonly(t.props), e]);
  ...
  e.render ||
    (t ||
      ...
      ((o = r.template) &&
        ...
        ({ isCustomElement: s, compilerOptions: i } = e.appContext.config),
        ({ delimiters: a, compilerOptions: l } = r),
        (l = extend(extend({ isCustomElement: s, delimiters: a }, i), l)),
...
function formatComponentName(e, n, t = !1) {
  ...
  var o;
  return (
    r || !n.__file || ((o = n.__file.match(/([^/\\]+)\.\w+$/)) && (r = o[1])),
    !r &&
      e &&
      e.parent &&
      ((o = (e) => {
...
const computed$1 = (e, t) => computed(e, t, isInSSRComponentSetup),
  warnRuntimeUsage = (e) =>
    warn$1(
      `${e}() is a compiler-hint helper that is only usable inside ` +
        '<script setup> of a single file component. Its arguments should be compiled away and passing it at runtime has no effect.'
    );
...
function setStyle(t, n, e) {
  ...
  isArray(e)
    ...
    : ((r = autoPrefix(t, n)),
      importantRE.test(e)
        ? t.setProperty(hyphenate(r), e.replace(importantRE, ''), 'important')
        : (t[r] = e));
}
...
function patchDOMProp(t, n, r, e, o, s, i) {
  ...
  if ('' === r || null == r) {
    a = typeof t[n];
    if ('boolean' == a) return void (t[n] = includeBooleanAttr(r));
    if (null == r && 'string' == a)
...
if ('undefined' != typeof window) {
  ...
  const dG = navigator.userAgent.match(/firefox\/(\d+)/i);
  skipTimestampCheck = !!(dG && Number(dG[1]) <= 53);
}
let cachedNow = 0;
...
function parseName(t) {
  ...
  return [hyphenate(t.slice(2)), n];
}
function createInvoker(e, n) {
  const r = (e) => {
    var t = e.timeStamp || _getNow();
    (skipTimestampCheck || t >= r.attached - 1) &&
      callWithAsyncErrorHandling(
        patchStopImmediatePropagation(e, r.value),
        n,
        5,
        [e]
      );
...
class VueElement extends BaseClass {
  ...
  _resolveDef() {
    if (!this._resolved) {
      ...
      var e = (e) => {
        var { props: t, styles: n } = e,
          e = !isArray(t);
        const r = t ? (e ? Object.keys(t) : t) : [];
        let o;
        if (e)
          for (const i in this._props) {
            var s = t[i];
            (s === Number || (s && s.type === Number)) &&
              ((this._props[i] = toNumber(this._props[i])),
              ((o = o || Object.create(null))[i] = !0));
          }
        this._numberProps = o;
        for (const a of Object.keys(this))
          '_' !== a[0] && this._setProp(a, this[a], !0, !1);
        for (const l of r.map(camelize))
...
function useCssVars(e) {
  const t = getCurrentInstance();
  if (t) {
    const n = () => setVarsOnVNode(t.subTree, e(t.proxy));
    watchPostEffect(n),
      onMounted(() => {
...
function resolveTransitionProps(e) {
  ...
  const m = h && h[0],
    ...
    x = (e, t) => {
      removeTransitionClass(e, f), removeTransitionClass(e, d), t && t();
    };
  h = (o) => (e, t) => {
    const n = o ? T : y,
      r = () => w(e, o, t);
      ...
      addTransitionClass(e, u),
        ...
        nextFrame(() => {
          removeTransitionClass(e, u),
            ...
            hasExplicitCallback(C) || whenTransitionEnds(e, s, g, n);
        }),
        callHook$1(C, [e, n]);
    },
    onEnterCancelled(e) {
...
function normalizeDuration(e) {
  ...
  if (isObject(e)) return [NumberOf(e.enter), NumberOf(e.leave)];
  e = NumberOf(e);
  return [e, e];
}
function NumberOf(e) {
...
function getTransitionInfo(e, t) {
  ...
  var r = (e) => (n[e] || '').split(', '),
    o = r(TRANSITION + 'Delay'),
    s = r(TRANSITION + 'Duration'),
    e = getTimeout(o, s),
    o = r(ANIMATION + 'Delay'),
    r = r(ANIMATION + 'Duration'),
    o = getTimeout(o, r);
  let i = null,
    a = 0,
    l = 0;
  t === TRANSITION
    ? 0 < e && ((i = TRANSITION), (a = e), (l = s.length))
    : t === ANIMATION
    ? 0 < o && ((i = ANIMATION), (a = o), (l = r.length))
    : ((a = Math.max(e, o)),
      (i = 0 < a ? (o < e ? TRANSITION : ANIMATION) : null),
      (l = i ? (i === TRANSITION ? s : r).length : 0));
  r =
    i === TRANSITION &&
    /\b(transform|all)(,|$)/.test(n[TRANSITION + 'Property']);
  return { type: i, timeout: a, propCount: l, hasTransform: r };
}
...
function hasCSSTransform(e, t, n) {
  ...
  o.appendChild(r);
  var t = getTransitionInfo(r)['hasTransform'];
...
function onCompositionEnd(e) {
  const t = e.target;
  t.composing && ((t.composing = !1), trigger$1(t, 'input'));
}
...
const render = (...e) => {
  ...
  createApp = (...e) => {
    ...
    injectNativeTagCheck(r), injectCompilerOptionsCheck(r);
    const o = r['mount'];
    return (
      (r.mount = (e) => {
  ...
  createSSRApp = (...e) => {
    ...
    injectNativeTagCheck(t), injectCompilerOptionsCheck(t);
    const n = t['mount'];
    return (
      (t.mount = (e) => {
...
function toValidAssetId(n, e) {
  return `_${e}_${n.replace(/[^\w]/g, (e, t) =>
...
function warnDeprecation(e, t, n, ...r) {
  if ('suppress-warning' !== getCompatValue(e, t)) {
    const { message: o, link: s } = deprecationData[e];
    r = `(deprecation ${e}) ${'function' == typeof o ? o(...r) : o}${
      s ? `\n  Details: ${s}` : ''
    }`;
...
function parseElement(e, t) {
  ...
  if (s.isSelfClosing || e.options.isVoidTag(s.tag))
    return i && (e.inPre = !1), n && (e.inVPre = !1), s;
  t.push(s);
  (r = e.options.getTextMode(s, o)), (r = parseChildren(e, r, t));
  return (
    t.pop(),
    (s.children = r),
...
function parseTag(t, e, n) {
  var r = getCursor(t),
    o = /^<\/?([a-z][^\t\r\n\f />]*)/i.exec(t.source),
    s = o[1],
    i = t.options.getNamespace(s, n);
  advanceBy(t, o[0].length), advanceSpaces(t);
  (n = getCursor(t)), (o = t.source);
...
function parseAttribute(r, o) {
  var e,
    s = getCursor(r);
  const i = /^[^\t\r\n\f />][^\t\r\n\f />=]*/.exec(r.source),
    a = i[0];
  o.has(a) && emitError(r, 2), o.add(a), '=' === a[0] && emitError(r, 19);
  {
    const n = /["'<]/g;
    for (; (e = n.exec(a)); ) emitError(r, 17, e.index);
  }
  advanceBy(r, a.length);
  let t = void 0;
  /^[\t\r\n\f ]*=/.test(r.source) &&
    (advanceSpaces(r),
    advanceBy(r, 1),
    advanceSpaces(r),
    (t = parseAttributeValue(r)),
    t || emitError(r, 13));
  const l = getSelection(r, s);
  if (r.inVPre || !/^(v-[A-Za-z0-9-]|:|\.|@|#)/.test(a))
    return (
      !r.inVPre && startsWith(a, 'v-') && emitError(r, 26),
      {
        type: 6,
        name: a,
        value: t && { type: 2, content: t.content, loc: t.loc },
        loc: l,
      }
    );
  {
    ...
    var c = startsWith(a, '.'),
      p =
        i[1] ||
        (c || startsWith(a, ':') ? 'bind' : startsWith(a, '@') ? 'on' : 'slot');
    let n;
    if (i[2]) {
      var u = 'slot' === p,
        o = a.lastIndexOf(i[2]);
      const l = getSelection(
        r,
        getNewPosition(r, s, o),
        getNewPosition(r, s, o + i[2].length + ((u && i[3]) || '').length)
      );
      let e = i[2],
        t = !0;
      e.startsWith('[')
    ...
    if (t && t.isQuoted) {
      ...
      f.start.offset++,
        f.start.column++,
        (f.end = advancePositionWithClone(f.start, t.content)),
...
function parseInterpolation(e, t) {
  ...
  if (-1 !== o) {
    var s = getCursor(e);
    advanceBy(e, n.length);
    var i = getCursor(e),
      a = getCursor(e),
      l = o - n.length,
      o = e.source.slice(0, l);
    const c = parseTextData(e, l, t);
    (n = c.trim()), (t = c.indexOf(n));
    return (
      0 < t && advancePositionWithMutation(i, o, t),
      advancePositionWithMutation(a, o, l - (c.length - n.length - t)),
...
function getCursor(e) {
  var { column: t, line: n, offset: e } = e;
  return { column: t, line: n, offset: e };
}
  ...
  for (let e = 0; e < r.length; e++) {
    ...
    if (1 === l.type && 0 === l.tagType) {
      ...
      if (0 < i) {
        ...
        13 === c.type &&
          (((i = getPatchFlag(c)) && 512 !== i && 1 !== i) ||
            !(2 <= getGeneratedPropsConstantType(l, t)) ||
            ((a = getNodeProps(l)) && (c.props = t.hoist(a))),
          c.dynamicProps && (c.dynamicProps = t.hoist(c.dynamicProps)));
      }
    } else
      12 === l.type &&
        2 <= getConstantType(l.content, t) &&
        ((l.codegenNode = t.hoist(l.codegenNode)), s++);
    if (1 === l.type) {
      var a = 1 === l.tagType;
      a && t.scopes.vSlot++, walk(l, t), a && t.scopes.vSlot--;
    } else if (11 === l.type) walk(l, t, 1 === l.children.length);
    else if (9 === l.type)
      for (let e = 0; e < l.branches.length; e++)
        walk(l.branches[e], t, 1 === l.branches[e].children.length);
  }
...
function generate(t, e = {}) {
  ...
  var p = 0 < t.helpers.length,
    u = !s && 'module' !== r;
  genFunctionPreamble(t, n);
  ...
  if (
    ...
    u &&
      ...
      p &&
        (o(
          `const { ${t.helpers
            .map((e) => `${helperNameMap[e]}: _${helperNameMap[e]}`)
            .join(', ')} } = _Vue`
        ),
        o('\n'),
        l())),
...
function genAssets(n, r, { helper: e, push: o, newline: s, isTS: i }) {
  ...
  for (let t = 0; t < n.length; t++) {
    ...
    l && (e = e.slice(0, -6)),
      o(
        `const ${toValidAssetId(e, r)} = ${a}(${JSON.stringify(e)}${
          l ? ', true' : ''
        })${i ? '!' : ''}`
      ),
      t < n.length - 1 && s();
...
function genVNodeCall(e, t) {
  ...
  p && n(r(WITH_DIRECTIVES) + '('),
    ...
    o && n(PURE_ANNOTATION);
  f = (u ? getVNodeBlockHelper : getVNodeHelper)(t.inSSR, f);
  n(r(f) + '(', e),
...
function genConditionalExpression(e, t) {
  var { test: n, consequent: r, alternate: o, newline: s } = e;
  const { push: i, indent: a, deindent: l, newline: c } = t;
  4 === n.type
    ? ((e = !isSimpleIdentifier(n.content)) && i('('),
      genExpression(n, t),
      e && i(')'))
    : (i('('), genNode(n, t), i(')')),
    s && a(),
    ...
    i(': ');
  r = 19 === o.type;
  r || t.indentLevel++, genNode(o, t), r || t.indentLevel--, s && l(!0);
}
...
const prohibitedKeywordRE = new RegExp(
  ...
  stripStringRE =
    /'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g;
function validateBrowserExpression(n, r, o = !1, e = !1) {
  const s = n.content;
  if (s.trim())
    try {
      new Function(e ? ` ${s} ` : `return ${o ? `(${s}) => {}` : `(${s})`}`);
    } catch (e) {
      let t = e.message;
      o = s.replace(stripStringRE, '').match(prohibitedKeywordRE);
      o && (t = `avoid using JavaScript keyword as property name: "${o[0]}"`),
        r.onError(createCompilerError(44, n.loc, void 0, t));
    }
}
...
function processIf(t, n, r, o) {
  if (
    ('else' === n.name ||
      ...
      (n.exp = createSimpleExpression('true', !1, s))),
...
function createIfBranch(e, t) {
  return {
    ...
    children: 3 !== e.tagType || findDir(e, 'for') ? [e] : e.children,
...
function createChildrenCodegenNode(n, e, r) {
  const o = r['helper'];
  var s = createObjectProperty(
    'key',
    createSimpleExpression(`${e}`, !1, locStub, 2)
  );
  const i = n['children'];
  var t = i[0];
  if (1 !== i.length || 1 !== t.type) {
    if (1 === i.length && 11 === t.type) {
      e = t.codegenNode;
      return injectProp(e, s, r), e;
    }
    {
      let e = 64,
        t = PatchFlagNames[64];
  ...
  (n = t.codegenNode), (t = getMemoedVNodeCall(n));
  return 13 === t.type && makeBlock(t, r), injectProp(t, s, r), n;
}
...
const transformFor = createStructuralDirectiveTransform('for', (d, e, f) => {
  ...
  return processFor(d, e, f, (s) => {
    const i = createCallExpression(h(RENDER_LIST), [s.source]),
      a = isTemplateNode(d),
      l = findDir(d, 'memo');
...
function parseForExpression(n, r) {
  ...
  if (i) {
    ...
    if (p) {
      ...
      let e;
      n &&
        ((e = s.indexOf(n, a + t.length)),
        (c.key = createAliasExpression(o, n, e)),
        ...
        !p[2] ||
          ((i = p[2].trim()) &&
            ((c.index = createAliasExpression(
              o,
              i,
              s.indexOf(i, c.key ? e + n.length : a + t.length)
            )),
            validateBrowserExpression(c.index, r, !0)));
    }
    return (
      t &&
        ((c.value = createAliasExpression(o, t, a)),
...
function buildSlots(e, r, o = buildClientSlotFn) {
  ...
  for (let n = 0; n < s.length; n++) {
    var m = s[n];
    let t;
    if (isTemplateNode(m) && (t = findDir(m, 'slot', !0))) {
      if (p) {
        r.onError(createCompilerError(37, t.loc));
        break;
      }
      u = !0;
      var { children: g, loc: v } = m,
        { arg: y = createSimpleExpression('default', !0), exp: E, loc: C } = t;
      let e;
      ...
      if ((g = findDir(m, 'if')))
      ...
      else if ((v = findDir(m, /^else(-if)?$/, !0))) {
        let e = n,
          t;
        for (; e-- && ((t = s[e]), 3 === t.type); );
        ...
        if (e) {
          if (h.has(e)) {
            r.onError(createCompilerError(38, C));
            continue;
          }
  ...
  p ||
    ...
    u
      ? f.length &&
        f.some((e) => isNonWhitespaceContent(e)) &&
        (d
          ? r.onError(createCompilerError(39, f[0].loc))
          : i.push(c(void 0, f)))
      : i.push(c(void 0, s)));
  e = l ? 2 : hasForwardedSlots(e.children) ? 3 : 1;
  let S = createObjectExpression(
    i.concat(
      createObjectProperty(
        '_',
        createSimpleExpression(e + ` /* ${slotFlagsText[e]} */`, !1)
      )
    ),
    n
  );
  return (
    a.length &&
      (S = createCallExpression(r.helper(CREATE_SLOTS), [
        S,
...
const directiveImportMap = new WeakMap(),
  transformElement = (v, y) =>
    function () {
      if (
        1 === (v = y.currentNode).type &&
        (0 === v.tagType || 1 === v.tagType)
      ) {
        var l,
          c,
          p,
          { tag: u, props: d } = v,
          f = 1 === v.tagType,
          h = f ? resolveComponentType(v, y) : `"${u}"`,
          m = isObject(h) && h.callee === RESOLVE_DYNAMIC_COMPONENT;
        let e,
          t,
          n,
          r = 0,
        ...
        if (0 < d.length) {
          d = buildProps(v, y);
          (e = d.props), (r = d.patchFlag), (s = d.dynamicPropNames);
          const g = d.directives;
          (i =
            g && g.length
              ? createArrayExpression(g.map((e) => buildDirectiveArgs(e, y)))
              : void 0),
            d.shouldUseBlock && (a = !0);
        }
        0 < v.children.length &&
          (h === KEEP_ALIVE &&
            ((a = !0),
            ...
            1 < v.children.length &&
              y.onError(
                createCompilerError(45, {
                  start: v.children[0].loc.start,
                  end: v.children[v.children.length - 1].loc.end,
                  source: '',
                })
              )),
          f && h !== TELEPORT && h !== KEEP_ALIVE
            ? (({ slots: l, hasDynamicSlots: c } = buildSlots(v, y)),
              (t = l),
              c && (r |= 1024))
            : (t =
                1 === v.children.length && h !== TELEPORT
                  ? ((c = 5 === (l = (p = v.children[0]).type) || 8 === l) &&
                      0 === getConstantType(p, y) &&
                      (r |= 1),
                    c || 2 === l ? p : v.children)
                  : v.children)),
          0 !== r &&
...
function resolveComponentType(e, t, n = !1) {
  ...
  e = !o && findDir(e, 'is');
  if (e && e.exp)
    return createCallExpression(t.helper(RESOLVE_DYNAMIC_COMPONENT), [e.exp]);
  e = isCoreComponent(r) || t.isBuiltInComponent(r);
  return e
    ? (n || t.helper(e), e)
...
function buildProps(t, o, n = t.props, r = !1) {
  var { tag: s, loc: i, children: e } = t;
  const a = 1 === t.tagType;
  let l = [];
  const c = [],
    p = [];
      ...
      a ||
        ...
        20 === t.type ||
          ...
          ('ref' === n
            ...
            : 'style' === n
            ? (g = !0)
            : 'key' === n || C.includes(n) || C.push(n),
          !a || ('class' !== n && 'style' !== n) || C.includes(n) || C.push(n));
    } else y = !0;
  };
  for (let e = 0; e < n.length; e++) {
    var b = n[e];
    if (6 === b.type) {
      const { loc: P, name: I, value: A } = b;
      'ref' === I &&
        ((h = !0),
        0 < o.scopes.vFor &&
          l.push(
        ...
        ('is' === I &&
          (isComponentTag(s) || (A && A.content.startsWith('vue:')))) ||
          l.push(
            createObjectProperty(
              createSimpleExpression(I, !0, getInnerRange(P, 0, I.length)),
              createSimpleExpression(A ? A.content : '', !0, A ? A.loc : P)
            )
          );
    } else {
      var { name: T, arg: _, exp: w, loc: x } = b,
        R = 'bind' === T,
        O = 'on' === T;
      if ('slot' !== T) {
        if (
          ...
          !(
            'is' === T ||
            (R && isStaticArgOf(_, 'is') && isComponentTag(s)) ||
            (O && r)
          )
        )
          if (
            (((R && isStaticArgOf(_, 'key')) ||
              (O && u && isStaticArgOf(_, 'vue:before-update'))) &&
              (d = !0),
            R &&
              isStaticArgOf(_, 'ref') &&
              0 < o.scopes.vFor &&
            ...
            const M = o.directiveTransforms[T];
            if (M) {
              const { props: n, needRuntime: V } = M(b, t, o);
              r || n.forEach(S),
                l.push(...n),
                V && (p.push(b), isSymbol(V) && directiveImportMap.set(b, V));
            } else isBuiltInDirective(T) || (p.push(b), u && (d = !0));
          } else
            (y = !0),
              w
                ? (l.length &&
                    (c.push(createObjectExpression(dedupeProperties(l), i)),
                    (l = [])),
                  R
                    ? c.push(w)
                    : c.push({
                ...
                : o.onError(createCompilerError(R ? 34 : 35, x));
      } else a || o.onError(createCompilerError(40, x));
    }
  }
  let N = void 0;
  if (
    (c.length
      ? (l.length && c.push(createObjectExpression(dedupeProperties(l), i)),
        (N =
          1 < c.length
            ? createCallExpression(o.helper(MERGE_PROPS), c, i)
            : c[0]))
      : l.length && (N = createObjectExpression(dedupeProperties(l), i)),
    y
      ? (f |= 16)
      : (m && !a && (f |= 2),
        g && !a && (f |= 4),
        C.length && (f |= 8),
        v && (f |= 32)),
    d || (0 !== f && 32 !== f) || !(h || E || 0 < p.length) || (f |= 512),
    !o.inSSR && N)
  )
    switch (N.type) {
      case 15:
        let t = -1,
          n = -1,
          r = !1;
        for (let e = 0; e < N.properties.length; e++) {
          var k = N.properties[e].key;
          isStaticExp(k)
            ? 'class' === k.content
              ? (t = e)
              : 'style' === k.content && (n = e)
        ...
        const $ = N.properties[t],
          F = N.properties[n];
        r
          ? (N = createCallExpression(o.helper(NORMALIZE_PROPS), [N]))
          : ($ &&
              !isStaticExp($.value) &&
              ($.value = createCallExpression(o.helper(NORMALIZE_CLASS), [
                $.value,
              ])),
            !F ||
              isStaticExp(F.value) ||
              (!g && 17 !== F.value.type) ||
              (F.value = createCallExpression(o.helper(NORMALIZE_STYLE), [
                F.value,
              ])));
        break;
      case 14:
        break;
      default:
        N = createCallExpression(o.helper(NORMALIZE_PROPS), [
          createCallExpression(o.helper(GUARD_REACTIVE_PROPS), [N]),
        ]);
    }
  return {
    props: N,
...
function buildDirectiveArgs(e, t) {
  ...
  if (
    ...
    const o = createSimpleExpression('true', !1, t);
    n.push(
...
function processSlotOutlet(t, e) {
  ...
  return (
    0 < o.length &&
      (({ props: s, directives: i } = buildProps(t, e, o)),
      (r = s),
...
const fnExpRE =
  ...
  transformOn = (e, t, n, r) => {
    ...
    if (4 === i.type)
      if (i.isStatic) {
        ...
        e.startsWith('vue:') && (e = `vnode-${e.slice(4)}`),
          (a = createSimpleExpression(toHandlerKey(camelize(e)), !0, i.loc));
      } else
      ...
      (a = i),
        a.children.unshift(`${n.helperString(TO_HANDLER_KEY)}(`),
        a.children.push(')');
    let l = e.exp;
    l && !l.content.trim() && (l = void 0);
    var c = n.cacheHandlers && !l && !n.inVOnce;
    l &&
    ...
    return (
      r && (p = r(p)),
      c && (p.props[0].value = n.cache(p.props[0].value)),
        ...
        for (let t = 0; t < n.length; t++) {
          ...
          if (isText(o)) {
            ...
            for (let e = t + 1; e < n.length; e++) {
              ...
              (r = r || (n[t] = { type: 8, loc: o.loc, children: [o] })),
                r.children.push(' + ', s),
                n.splice(e, 1),
                e--;
            }
  ...
  transformModel = (e, t, n) => {
    ...
    var a = o || createSimpleExpression('modelValue', !0),
      s = o
        ? isStaticExp(o)
          ? `onUpdate:${o.content}`
          : createCompoundExpression(['"onUpdate:" + ', o])
        : 'onUpdate:modelValue',
      r = createCompoundExpression([
        `${n.isTS ? '($event: any)' : '$event'} => ((`,
        r,
        ') = $event)',
      ]);
    const l = [createObjectProperty(a, e.exp), createObjectProperty(s, r)];
    return (
      e.modifiers.length &&
        1 === t.tagType &&
        ((t = e.modifiers
        ...
        l.push(
          createObjectProperty(
            o,
            createSimpleExpression(`{ ${t} }`, !1, e.loc, 2)
          )
        )),
...
function baseCompile(e, t = {}) {
  ...
  !0 === t.prefixIdentifiers
    ...
    : r && n(createCompilerError(47));
  t.cacheHandlers && n(createCompilerError(48)),
    t.scopeId && !r && n(createCompilerError(49));
  var o = isString(e) ? baseParse(e, t) : e,
    [r, e] = getBaseTransformPreset();
  return (
    transform(
      o,
      extend({}, t, {
        ...
        directiveTransforms: extend({}, e, t.directiveTransforms || {}),
      })
    ),
    generate(o, extend({}, t, { prefixIdentifiers: !1 }))
  );
}
...
const DOMErrorMessages = {
  ...
  transformVHtml = (e, t, n) => {
    var { exp: r, loc: e } = e;
    return (
      r || n.onError(createDOMCompilerError(50, e)),
      t.children.length &&
        (n.onError(createDOMCompilerError(51, e)), (t.children.length = 0)),
      {
        props: [
          createObjectProperty(
            createSimpleExpression('innerHTML', !0, e),
  ...
  transformVText = (e, t, n) => {
    var { exp: r, loc: e } = e;
    return (
      r || n.onError(createDOMCompilerError(52, e)),
      t.children.length &&
        (n.onError(createDOMCompilerError(53, e)), (t.children.length = 0)),
      {
        props: [
          createObjectProperty(
            createSimpleExpression('textContent', !0),
            r
              ? createCallExpression(n.helperString(TO_DISPLAY_STRING), [r], e)
  ...
  transformModel$1 = (n, r, o) => {
    ...
    function i() {
      ...
      e && o.onError(createDOMCompilerError(57, e.loc));
    }
    n.arg && o.onError(createDOMCompilerError(55, n.arg.loc));
    var a = r['tag'],
          ...
          if (7 === l.type) e = V_MODEL_DYNAMIC;
            ...
            switch (l.value.content) {
              ...
              case 'checkbox':
                ...
                break;
              case 'file':
                (t = !0), o.onError(createDOMCompilerError(56, n.loc));
                break;
              default:
                i();
            }
    ...
    } else o.onError(createDOMCompilerError(54, n.loc));
    return (
  ...
  transformOn$1 = (a, e, l) =>
    transformOn(a, e, l, (e) => {
      ...
      return (
        ...
        i.length &&
          ((t = i.map(capitalize).join('')),
          (n = isStaticExp(n)
            ? createSimpleExpression(`${n.content}${t}`, !0)
            : createCompoundExpression(['(', n, `) + "${t}"`]))),
  ...
  transformShow = (e, t, n) => {
    var { exp: r, loc: e } = e;
    return (
      r || n.onError(createDOMCompilerError(58, e)),
      { props: [], needRuntime: n.helper(V_SHOW) }
    );
  },
  warnTransitionChildren = (e, t) => {
    if (
      1 === e.type &&
      1 === e.tagType &&
      t.isBuiltInComponent(e.tag) === TRANSITION$1
    )
      return () => {
        e.children.length &&
          hasMultipleChildren(e) &&
          t.onError(
            createDOMCompilerError(59, {
...
const ignoreSideEffectTags = (e, t) => {
    1 !== e.type ||
      ...
      (t.onError(createDOMCompilerError(60, e.loc)), t.removeNode());
  },
  DOMNodeTransforms = [transformStyle, warnTransitionChildren],
...
function compileToFunction(n, e) {
  ...
  var e = compile$1(
    n,
    extend({ hoistStatic: !0, onError: o, onWarn: (e) => o(e, !0) }, e)
  )['code'];
  function o(e, t = !1) {
  ...
  const s = new Function('Vue', e)(runtimeDom);
  return (s._rc = !0), (compileCache[t] = s);
}
